import { IntroContent } from '@/home/Intro'

export const HAS_VOTED_LOCAL_DATA_KEY = 'hasVoted'

export const SECTION_INTRO_CONTENT: IntroContent = {
  title: '[인트로 문구]',
  description: [
...
export const SECTION_START_CONTENT = {
...
export const SECTION_CHANGE_CONTENT = {
...
export const SECTION_FUTURE_CONTENT = {
  title: '함께 꿈꾸는 창작의 미래',
  description: [
